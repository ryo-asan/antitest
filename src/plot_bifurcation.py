...
plt.tight_layout()
plt.savefig(os.path.join(base_dir, "bifurcation_H10.png"), dpi=300)
plt.close()
...
plt.grid(True, linestyle='--', alpha=0.7)
plt.tight_layout()
plt.savefig(os.path.join(base_dir, "bifurcation_L2.png"), dpi=300)
plt.close()
...
plt.grid(True, linestyle='--', alpha=0.7)
plt.tight_layout()
plt.savefig(os.path.join(base_dir, "bifurcation_Linf.png"), dpi=300)
plt.close()
