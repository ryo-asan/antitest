    ...
    for (double alpha : alphas) {
        for (double epsilon : epsilons) {
            ...
            for (int trial = 1; trial <= 100; ++trial) {
                ...
                ss_init << data_dir << "/eps_" << std::fixed << std::setprecision(4) << epsilon 
                ...
                if (converged) {
                    ...
                    ss_uh << data_dir << "/eps_" << std::fixed << std::setprecision(4) << epsilon 
                          << "_alpha_" << std::setprecision(2) << alpha
                          << "_trial_" << trial
                          << "_H10_" << std::setprecision(5) << (double)H10_norm << "_uh";
                    ss_vh << data_dir << "/eps_" << std::fixed << std::setprecision(4) << epsilon 
                          << "_alpha_" << std::setprecision(2) << alpha
                          << "_trial_" << trial
                          << "_H10_" << std::setprecision(5) << (double)H10_norm << "_vh";
                    ss_wh << data_dir << "/eps_" << std::fixed << std::setprecision(4) << epsilon 
                          << "_alpha_" << std::setprecision(2) << alpha
                          << "_trial_" << trial
